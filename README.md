...
<p align="justify"> Enfin, pour télécharger MOPPI, il suffit de cliquer sur le bouton vert en haut à droite de cette page, puis de cliquer sur l'option Download ZIP. Il faut alors dézipper le dossier, puis prendre le dossier nommé "MOPPI" pour le placer dans un répertoire dont le chemin est du type "C:\Program Files\QGIS 2.18\apps\qgis\python\plugins\". </p>
