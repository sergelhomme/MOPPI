...
class Ui_DialogDistancierInfoTM(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(450, 280, 291, 32))
        ...
        self.comboBoxf.setGeometry(QtCore.QRect(140, 160, 221, 22))
        self.comboBoxf.setFont(font)
        self.comboBoxf.setObjectName("comboBoxf")
        self.labelf = QtGui.QLabel(Dialog)
        self.labelf.setGeometry(QtCore.QRect(30, 162, 91, 20))
        ...
        self.lineedit2.setGeometry(QtCore.QRect(140, 240, 321, 22))
        self.lineedit2.setFont(font)
        self.lineedit2.setObjectName("lineedit2")
        self.labele = QtGui.QLabel(Dialog)
        self.labele.setGeometry(QtCore.QRect(30, 242, 91, 20))
        ...
        self.comboBox2f.setGeometry(QtCore.QRect(520, 160, 221, 22))
        self.comboBox2f.setFont(font)
        self.comboBox2f.setObjectName("comboBox2f")
        self.label2f = QtGui.QLabel(Dialog)
        self.label2f.setGeometry(QtCore.QRect(400, 162, 101, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelf.setText(t.encode('latin-1'))

        self.labeld.setText(QtGui.QApplication.translate("Dialog", "Clef API Voiture", None))
        self.labele.setText(QtGui.QApplication.translate("Dialog", "Clef API TC", None))
        ...
        self.label2f.setText(t2.encode('latin-1'))
