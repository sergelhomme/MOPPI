...
class Ui_DialogOptim(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate("Dialog", "Couche Personnel", None))
        self.label2.setText(QtGui.QApplication.translate("Dialog", "Couche Etablissement", None))
        self.label3.setText(QtGui.QApplication.translate("Dialog", "Distancier", None))
        t = u"Résolution"
